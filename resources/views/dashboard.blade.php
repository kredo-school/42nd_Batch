...
<head>
  ...
  <style>
    ...
    .sidebar-logo {
      padding:0 18px 24px; border-bottom:1px solid rgba(255,255,255,.07);
      margin-bottom:16px; display:flex; align-items:center; gap:10px;
    }
    .logo-icon {
      width:40px; height:40px;
      background:linear-gradient(135deg,var(--amber),#D4956A);
    ...
    .nav-section-label {
      ...
      text-transform:uppercase; color:rgba(255,255,255,.25); padding:8px 22px 4px;
    }
    .sidebar .nav-link {
      display:flex; align-items:center; gap:10px; padding:10px 22px;
      color:rgba(255,255,255,.5); font-size:13px; font-weight:500;
      border-left:3px solid transparent; border-radius:0; transition:.18s;
    }
    .sidebar .nav-link:hover { background:rgba(255,255,255,.05); color:rgba(255,255,255,.85); }
    .sidebar .nav-link.active {
      background:rgba(200,134,58,.12); border-left-color:var(--amber);
      color:white; font-weight:600;
    }
    .sidebar-footer {
      margin-top:auto; padding:16px 22px 0;
    ...
    .logout-btn {
      ...
      padding:10px 0; width:100%; margin-top:10px;
    ...
    .topbar {
      height:60px; background:rgba(253,250,244,.9);
      backdrop-filter:blur(16px); border-bottom:1px solid rgba(28,26,23,.07);
      position:sticky; top:0; z-index:50;
    }
    .topbar-btn {
      width:36px; height:36px; border-radius:50%;
      background:white; border:1px solid rgba(28,26,23,.1);
    ...
    .hero-card::before {
      ...
      background:radial-gradient(circle,rgba(200,134,58,.2) 0%,transparent 70%);
      top:-80px; right:-60px; border-radius:50%;
    }
    .hero-eyebrow {
      font-size:11px; font-weight:700; letter-spacing:.15em;
      text-transform:uppercase; color:var(--amber-light); margin-bottom:8px;
    }
    .hero-title { font-family:'DM Serif Display',serif; font-size:32px; }
    .hero-sub { font-size:14px; color:rgba(255,255,255,.45); }
    ...
    .kpi-empty-val {
      ...
      color:#D3D1C7; line-height:1; margin-bottom:6px;
    }
    ...
    /* ── Get started banner ── */
    .getstarted-banner {
      background:linear-gradient(135deg,var(--amber-pale),#FDF3E3);
      border:1.5px solid rgba(200,134,58,.25);
...
<body>
  ...
  <div class="sidebar">
    ...
    <ul class="nav flex-column">
      <li class="nav-item"><a class="nav-link active" href="#"><span>🏠</span> Home</a></li>
    ...
    <ul class="nav flex-column">
      <li class="nav-item"><a class="nav-link" href="#"><span>👤</span> Profile</a></li>
  ...
  <div class="main-content">
    ...
    <div class="p-4">
        ...
        <div class="row align-items-center position-relative">
          <div class="col-8">
            ...
            <div class="hero-sub mb-4">
              Your journey starts here. Record your first reflection today!
            </div>
          ...
          <div class="col-4 text-end">
            <div style="font-size:11px;color:rgba(255,255,255,.35);letter-spacing:.1em;text-transform:uppercase;margin-bottom:8px;">
              Weekly Growth Score
            </div>
            <div style="font-family:'DM Serif Display',serif;font-size:72px;line-height:1;color:rgba(255,255,255,.15);">
              --
            </div>
      ...
      <div class="getstarted-banner mb-4 d-flex align-items-center gap-3">
        ...
        <div class="flex-grow-1">
          ...
          <div style="font-size:12px;color:var(--ink-muted);margin-top:2px;">
            Complete the steps below to set up your growth journey.
          </div>
        </div>
      ...
      <div class="row g-3 mb-4">
        <div class="col-3">
          <div class="kpi-card shadow-sm" style="border-top:3px solid #D3D1C7">
            <div class="kpi-label">Days Logged</div>
            <div class="kpi-empty-val">0</div>
            <div class="kpi-empty-hint">Start your first log →</div>
          </div>
        </div>
        <div class="col-3">
          <div class="kpi-card shadow-sm" style="border-top:3px solid #D3D1C7">
            ...
            <div class="kpi-empty-val">0</div>
            <div class="kpi-empty-hint">No activity logged yet</div>
          </div>
        </div>
        <div class="col-3">
          <div class="kpi-card shadow-sm" style="border-top:3px solid #D3D1C7">
            <div class="kpi-label">Avg Mood Score</div>
            <div class="kpi-empty-val">--</div>
            <div class="kpi-empty-hint">Log mood to see score</div>
          </div>
        </div>
        <div class="col-3">
          <div class="kpi-card shadow-sm" style="border-top:3px solid #D3D1C7">
            ...
            <div class="kpi-empty-val">--%</div>
            <div class="kpi-empty-hint">Set your first goal →</div>
          </div>
        </div>
      </div>
      ...
      <div class="row g-4">
        ...
        <div class="col-8">
          ...
          <div class="card border-0 shadow-sm rounded-4 p-3 mb-4">
            <div class="d-flex gap-2 justify-content-between">
              ...
              <div class="text-center flex-fill">
                ...
                <div class="mood-lbl">{{ $day }}</div>
              </div>
              @endforeach
              <div class="text-center flex-fill">
                <div class="mood-today">＋</div>
                <div class="mood-lbl" style="color:var(--blue);font-weight:700">Today</div>
              </div>
            </div>
            <div class="text-center mt-3" style="font-size:12px;color:var(--ink-muted);">
              Log your mood each day to see your weekly trend here.
            </div>
          </div>
          ...
          <div class="empty-state shadow-sm">
            ...
            <div class="empty-sub">
              Write your first reflection to start tracking<br>your thoughts and growth journey.
            </div>
        ...
        <div class="col-4">
          ...
          <div class="row g-2 mb-4">
            <div class="col-6">
              <div class="quick-card" style="background:var(--ink);color:white">
                <div class="qc-icon">✍️</div>
                <div class="qc-title">Write Reflection</div>
          ...
          <div class="empty-state shadow-sm">
            ...
            <div class="empty-sub">
              Set your first monthly goal<br>to start tracking progress.
            </div>
            <button class="btn fw-semibold px-4"
                    style="background:var(--purple-pale);color:var(--purple);border-radius:10px;font-size:13px;">
              🎯 Set First Goal
            </button>
          </div>
