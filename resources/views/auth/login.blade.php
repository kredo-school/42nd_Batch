...
<head>
  ...
  <style>
    ...
    /* ── Left panel ── */
    .auth-left {
      background:linear-gradient(155deg,#2A2420,#3D3228);
    ...
    .auth-left::after {
      ...
      background:radial-gradient(circle,rgba(200,134,58,.1) 0%,transparent 70%);
    ...
    .auth-feat-icon {
      ...
      background:rgba(200,134,58,.2); display:flex; align-items:center; justify-content:center;
    ...
    .auth-tab-btn {
      ...
      cursor:pointer; transition:.2s; background:transparent; color:var(--ink-muted);
    }
    .auth-tab-btn.active {
      background:white; color:var(--ink); font-weight:600;
      box-shadow:0 2px 10px rgba(28,26,23,.1);
    }
    ...
    .form-input-custom {
      ...
      border:1.5px solid rgba(28,26,23,.1); background:white;
    ...
    .btn-submit {
      ...
      background:var(--amber); color:white; font-family:'DM Sans',sans-serif;
      font-size:14px; font-weight:600; cursor:pointer; transition:.18s; margin-top:4px;
    }
...
<div class="auth-wrap" x-data="{
  ...
  get strengthColor() {
    return ['','#E24B4A','#BA7517','#7A9E7E','#1D9E75'][this.strength];
  }
}">
  ...
  <div class="auth-left">
    ...
    <div style="position:relative">
      <div class="d-flex gap-3 align-items-start mb-4">
        ...
        <div>
          <div class="feat-title">Visualize Growth Scores</div>
          <div class="feat-sub">AI analyzes and quantifies your growth every week</div>
        </div>
      </div>
      <div class="d-flex gap-3 align-items-start mb-4">
        <div class="auth-feat-icon">🎯</div>
        <div>
          <div class="feat-title">Manage Goals & Habits</div>
          <div class="feat-sub">Track weekly & monthly goal achievement rates</div>
        </div>
      </div>
      <div class="d-flex gap-3 align-items-start">
        <div class="auth-feat-icon">✨</div>
        <div>
          <div class="feat-title">AI Personal Coach</div>
          <div class="feat-sub">Personalized suggestions based on behavior patterns</div>
        </div>
      </div>
    </div>
  ...
  <div class="auth-right">
    ...
    <div x-show="tab === 'login'" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100">
      ...
      <div class="serif" style="font-size:28px;color:var(--ink);margin-bottom:4px;">Welcome Back</div>
      ...
      <form method="POST" action="{{ route('login') }}">
        ...
        <div class="mb-3">
          ...
          <input type="email" name="email" value="{{ old('email') }}" required autofocus
                 class="form-input-custom" placeholder="your@email.com">
        </div>
        <div class="mb-3">
          ...
          <input type="password" name="password" required
                 class="form-input-custom" placeholder="••••••••">
        </div>
      ...
      <p style="font-size:13px;color:var(--ink-muted);text-align:center;margin-top:20px;">
        ...
        <a href="#" @click.prevent="tab = 'register'" style="color:var(--amber);font-weight:600;text-decoration:none;">Sign Up</a>
      </p>
    </div>
    ...
    <div x-show="tab === 'register'" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100">
      ...
      <div class="serif" style="font-size:28px;color:var(--ink);margin-bottom:4px;">Create Account</div>
      ...
      <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mb-3">
          ...
          <input type="text" name="name" value="{{ old('name') }}" required
                 class="form-input-custom" placeholder="Your name">
        </div>
        <div class="mb-3">
          <label class="form-label-custom">Email</label>
        ...
        <div class="mb-1">
          ...
          <input type="password" name="password" required
                 class="form-input-custom" placeholder="8 characters or more"
                 x-model="password">
        </div>
        ...
        <div class="mb-4">
          ...
          <input type="password" name="password_confirmation" required
                 class="form-input-custom" placeholder="Re-enter password">
        </div>
      ...
      <p style="font-size:13px;color:var(--ink-muted);text-align:center;margin-top:16px;">
        ...
        <a href="#" @click.prevent="tab = 'login'" style="color:var(--amber);font-weight:600;text-decoration:none;">Log In</a>
      </p>
    </div>
